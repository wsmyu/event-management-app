...
public enum ErrorCode {
    ...
    GUEST_NOT_FOUND("No guests found for the provided event ID"),
    CANNOT_INVITE_SELF("Cannot invite yourself as a guest"),
    GUEST_ALREADY_INVITED("Guest is already invited to the event"),
    UNAUTHORIZED_GUEST_LIST_MANAGEMENT("Unauthorized to manage this event's guest list"),
